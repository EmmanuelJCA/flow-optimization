...
def main():
    ...
    if(n_porc > s_porc):
        print("\nEn este periodo de tiempo, el mejor sentido que podria tener la nueva via es el Sur->Norte, para optimizar los tiempos de viaje y disminuir el colapso de la via")
    else:
        print("\nEn este periodo de tiempo, el mejor sentido que podria tener la nueva via es el Norte->Sur, para optimizar los tiempos de viaje y disminuir el colapso de la via")
